      ...
      <Container>
        <div className="flex-1 max-w-[594px] pt-32">
          ...
          <p className="text-lg max-w-[554px] mb-16 text-second-gray">
            ...
            melhor, no conforto da sua casa.
          </p>
          <ul className="flex flex-col items-start gap-9">
            ...
            <li className="flex items-center gap-9 pb-9 border-b-[1px] border-opacity-gray">
              <div className="w-7 h-7 flex items-center justify-center">
                <Image src={SolutionIcon} alt="Icon solutions" />
              </div>
            ...
            <li className="flex items-center gap-9 pb-9 border-b-[1px] border-opacity-gray">
              ...
              <p className="flex-1 text-txt-gray pr-2">
                Diversão opções de investimentos, de acordo com o seu perfil de investidor.
              </p>
            </li>
            ...
            <li className="flex items-center gap-9">
              ...
              <p className="flex-1 text-txt-gray pr-2">
                Acompanhar a fatura do seu cartão de crédito e faça compras online com seu cartão
                virtual.
              </p>
            </li>
          </ul>
